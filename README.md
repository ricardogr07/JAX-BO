...
- [CONTRIBUTING.md](CONTRIBUTING.md): dev setup, tox environments, CI gates, PR rules, and benchmark policy
- [benchmarks/](benchmarks/README.md): the performance harness and reproducibility rules
- [docs/audits/2026-08-24-public-release.md](docs/audits/2026-08-24-public-release.md): current RepoSage audit
...
The `0.2.2` benchmark summary records four clean runs from the existing `.venv`, using the command and environment listed in [the evidence file](benchmarks/results/2026-08-15-rc-final.md). Historical ratios remain descriptive only because the cross-session noise bands are wide.
